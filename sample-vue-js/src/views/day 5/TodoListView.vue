...
<template>
  <div class="todo-view">
    ...
    <div v-else-if="error" class="error-box">Error: {{ error }}</div>
...
.filters button { padding: 6px 16px; border: 1px solid #ddd; border-radius: 20px; background: #f3f4f6; color: #374151; cursor: pointer; font-size: 13px; }
